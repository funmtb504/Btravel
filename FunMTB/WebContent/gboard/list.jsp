...
<tr><th class="tno">No.</th>
    <th class="ttitle">Image title</th>
    ...
    for(int i=0;i<boardList.size();i++){
    	...
    	%>
    <tr onclick="location.href='fcontent.jsp?num=<%=bb.getNum()%>&pageNum=<%=pageNum%>'"><td><%=num-- %></td>
    	<td class="left"><img src="../upload/<%=bb.getFile() %>" width="125" height="125"><%=bb.getSubject() %></td>
